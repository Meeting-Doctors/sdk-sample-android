@file:JvmName("RuntimeLocaleHelper")
...
object LocaleHelper {
    ...
    fun getLocaleWithoutCountry(context: Context): Locale {
        return loadWithoutCountry(context)
    }
    ...
    private fun loadWithoutCountry(context: Context): Locale {
        val preferences = getPreferences(context)
        val language = preferences.getString(SELECTED_LANGUAGE, Locale.getDefault().language)
